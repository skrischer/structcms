...
import { StorageError, SupabaseStorageAdapter, createStorageAdapter } from './supabase-adapter';
...
describe('SupabaseStorageAdapter', () => {
  ...
  describe('createStorageAdapter', () => {
    it.skipIf(!supabaseUrl || !supabaseKey)('should create a storage adapter', () => {
  ...
  describe('Page CRUD', () => {
    it.skipIf(!supabaseUrl || !supabaseKey)('should create a page with provided slug', async () => {
    ...
    it.skipIf(!supabaseUrl || !supabaseKey)('should create a page with custom slug', async () => {
      const page = await adapter.createPage({
    ...
    it.skipIf(!supabaseUrl || !supabaseKey)('should create a page with sections', async () => {
      const sections = [
    ...
    it.skipIf(!supabaseUrl || !supabaseKey)('should reject duplicate slugs', async () => {
    ...
    it.skipIf(!supabaseUrl || !supabaseKey)('should get page by slug', async () => {
    ...
    it.skipIf(!supabaseUrl || !supabaseKey)('should get page by id', async () => {
      const created = await adapter.createPage({
    ...
    it.skipIf(!supabaseUrl || !supabaseKey)('should update a page', async () => {
      const created = await adapter.createPage({
    ...
    it.skipIf(!supabaseUrl || !supabaseKey)('should delete a page', async () => {
      const created = await adapter.createPage({
    ...
    it.skipIf(!supabaseUrl || !supabaseKey)('should list pages', async () => {
      // Create a few pages
      await adapter.createPage({
    ...
    it.skipIf(!supabaseUrl || !supabaseKey)('should paginate pages', async () => {
  ...
  describe('Navigation CRUD', () => {
    it.skipIf(!supabaseUrl || !supabaseKey)('should create a navigation', async () => {
    ...
    it.skipIf(!supabaseUrl || !supabaseKey)('should get navigation by name', async () => {
      await adapter.createNavigation({
    ...
    it.skipIf(!supabaseUrl || !supabaseKey)('should update a navigation', async () => {
    ...
    it.skipIf(!supabaseUrl || !supabaseKey)('should delete a navigation', async () => {
      const created = await adapter.createNavigation({
    ...
    it.skipIf(!supabaseUrl || !supabaseKey)('should list navigations', async () => {
      await adapter.createNavigation({

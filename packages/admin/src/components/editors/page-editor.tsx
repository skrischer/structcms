...
function PageEditor({
  ...
  const showPageSettings = pageTitle != null || pageType != null || pageSlug != null;

  return (
    <div className={cn('flex-1 flex flex-col gap-6', className)} data-testid="page-editor">
      {showPageSettings && (
        <div
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-4 p-5">
            ...
            <div>
              <span className="block text-[13px] text-[var(--admin-gray-500)] mb-1.5">Slug</span>
              <div

...
function Select({
  ...
  return (
    <div ref={ref} className={cn("relative", className)}>
      ...
      {open && (
        <div className="absolute z-10 w-full bg-[var(--admin-surface-card)] border-l border-r border-b border-[var(--admin-gray-200)] rounded-b-md shadow-[var(--admin-shadow-md)]">
          {options.map((option) => {

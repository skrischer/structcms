  ...
  return (
    ...
    >
      <button
        ...
        className={cn(
          'flex items-center justify-center w-[18px] h-[18px] rounded-sm shrink-0 transition-colors focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-[var(--admin-shadow-ring)]',
          showCheck

...
function Sidebar({
  ...
  return (
    ...
    >
      {/* Logo section */}
      <div className="flex items-center justify-between h-14 px-4 border-b border-[var(--admin-gray-200)] shrink-0">
        {!collapsed && (
          <span
        ...
        >
          ...
          {!collapsed && (
            <div className="flex flex-col min-w-0">
              ...
              {userRole && (
                <span className="text-xs text-[var(--admin-gray-500)] truncate">{userRole}</span>
              )}
            </div>
          )}
        </div>
